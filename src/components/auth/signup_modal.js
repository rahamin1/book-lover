...
import { signUpUser } from '../../actions/actions_auth';
          ...
          <FormGroup>
            <Col {...colWidth}>
              { this.props.authError &&
                <Alert color="danger">
                  Unable to signup: {this.props.authError}
                </Alert>
              }
            </Col>
          </FormGroup>
  ...
  handleClearForm(e) {
	...
	handleFormSubmit(e) {
      ...
      password: this.state.password
		...
		this.props.signUpUser(formPayload);
	}
...
export default connect(mapStateToProps,
	{ hideModal, signUpUser })(SignupModal);
